 ...
 *
 *   ../browser-runtime/src/aria/aria-snapshot.bundle.txt   ← bundled CJS module
 *
...
const OUTPUT = path.join(import.meta.dir, "..", "..", "browser-runtime", "src", "aria", "aria-snapshot.bundle.txt");
